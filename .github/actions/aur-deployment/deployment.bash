...
echo "ENV_PACKAGE_VERSION: ${ENV_PACKAGE_VERSION}"
ENV_PACKAGE_VERSION="${ENV_PACKAGE_VERSION//${ENV_GITHUB_TAG_VERSION_PREFIX}/}"
echo "ENV_PACKAGE_VERSION: ${ENV_PACKAGE_VERSION}"
ENV_PACKAGE_VERSION="${ENV_PACKAGE_VERSION//${ENV_GITHUB_TAG_VERSION_SUFFIX}/}"
echo "ENV_PACKAGE_VERSION: ${ENV_PACKAGE_VERSION}"
